  ...
  return (
    <Router>
      ...
      <div className="content">
        ...
        <div className="block">
          <Route
            path="/inventory-manager/addinventory"
            exact
            component={AddInventory}
          />
          <Route path="/inventory-manager" exact component={InventoryList} />
          <Route
            path="/inventory-manager/displayinventory/:id"
            exact
          ...
          />
          <Route
            path="/inventory-manager/supplierview/:id"
            exact
            component={SuppliersView}
          />
          <Route path="/inventory-manager/restock" exact component={ReStock} />
          <Route
            path="/inventory-manager/checkout"
            exact
            component={InventoryCheckout}
          />
          <Route
            path="/inventory-manager/saleschart"
            exact
